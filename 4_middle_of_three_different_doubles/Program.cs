namespace _4_middle_of_three_different_doubles
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // находим максимум как в прошлой задаче, затем минимум аналогично, после чего максимум и минимум вычитаем из суммы всех трёх, тем самым находя третье число
            double maxdig = dig1;
